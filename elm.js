...
var _user$elm_encounters$Thing$view = function (model) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onInput(_user$elm_encounters$Thing$ModifyName)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
...
var _user$elm_encounters$ListofThing$init = {
	...
	_0: {
		uid: 1,
		thingList: _elm_lang$core$Native_List.fromArray(
			[])
	},
	_1: _elm_lang$core$Platform_Cmd$none
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Add Thing')
					]))
			]));
};
